                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              room['status'] ?? 'N/A',
                              style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: _getStatusColor(room['status'])),
                            ),
                          ),
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildOptionItem(Icons.visibility_off_outlined, 'Tạm ẩn tin', Colors.orange, () {
              Navigator.pop(context);
              // Hide logic
            }),
